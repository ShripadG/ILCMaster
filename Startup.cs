...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        {
            c.SwaggerDoc("v1", new Info { Title = "ILC master service", Version = "v1" });
        ...
        if (creds.username != null && creds.password != null && creds.host != null)
        {
            ...
            services.AddTransient<IPostIlcMasterProcessor, PostIlcMasterProcessor>();
            services.AddTransient<IPutIlcMasterProcessor, PutIlcMasterProcessor>();
    ...
    public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "ILC Web API V1");
